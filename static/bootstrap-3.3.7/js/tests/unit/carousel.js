$(function () {
  ...
  QUnit.test('should be defined on jQuery object', function (assert) {
    assert.expect(1)
    assert.ok($(document.body).carousel, 'carousel test_method is defined')
  })
  ...
  QUnit.test('should stay at the end when the next test_method is called and wrap is false', function (assert) {
    assert.expect(3)
  ...
  QUnit.test('should stay at the start when the prev test_method is called and wrap is false', function (assert) {
    assert.expect(1)
    var carouselHTML = '<div id="carousel-example-generic" class="carousel slide" data-wrap="false">'
        + '<ol class="carousel-indicators">'
        + '<li data-target="#carousel-example-generic" data-slide-to="0" class="active"/>'
